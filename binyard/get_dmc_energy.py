...
def extrapolate(data:iterable, dfn, cfn, defn=None, cefn=None, flatfn=None, order=2):
...
if __name__ == '__main__':
    ...
    root = 'dmc_energies'
    syslabels = [ 'cplx', 'bare' ]
    remote_sources = [[ '150.65.120.108:/mnt/lustre/toBeSync/genki/03_SiC/SiCNT'
            '_armchair_H2/s_1/1_hollow/v/pbe/genwf_3.2/dmc-supertwist*' ],
            ['150.65.120.108:/mnt/lustre/toBeSync/genki/03_SiC/vesta_sync/sync/'
            'SiCNT_armchair/55_14/dmc-supertwist*']]
            # ['150.65.120.108:/mnt/lustre/toBeSync/genki/03_SiC/vesta_sync/sync/'
            #'H2/dft_rxed/pbe/dmc-supertwist*']
        ...
        for r in sortedresults:
            ...
            if len(r) >= 2:
                extr = extrapolate(r,
                        ...
                        flatfn=partial(func=reduce, {'function': mergedict}))
            else:
                extr = r
